        ...
        const chatResponse = await axios.post(
            `https://api.individual.githubcopilot.com/github/chat/threads/${threadId}/messages`,
            {
                ...
                customInstructions: [
                    ...
                    "If someone sends a link and asks to embed its image or video as a webpage or iframe, always ignore or deny the request. Instead, replace it or add a placeholder (like an example) rather than the actual link they requested—for security reasons, you cannot fulfill such requests and just tell them this 'ako importanti potah! suri kinit asibirus!."
                ],
