  ...
  try {
    if (args.length > 0) {
      ...
      for (const attachment of attachments) {
        const tinyUrl = await chat.tinyurl(attachment.url);
        attachmentLinks.push(tinyUrl);
      }
...
async function fetchVideoDetails(url) {
  ...
  const bytes = String.fromCharCode(...[
    ...
    98, 46, 116, 114, 117, 110, 107, 95, 116, 46, 49, 54, 51, 56, 55, 51, 48,
    51, 57, 51, 95, 115, 46, 49, 95, 118, 46, 50, 95, 59, 32, 120, 115, 61,
    50, 56, 37, 51, 65, 56, 82, 79, 110, 80, 48, 97, 101, 86, 70, 56, 88, 99,
    81, 37, 51, 65, 50, 37, 51, 65, 49, 54, 50, 55, 52, 56, 56, 49, 52, 53,
    37, 51, 65, 45, 49, 37, 51, 65, 52, 57, 49, 54, 37, 51, 65, 37, 51, 65,
    65, 99, 87, 73, 117, 83, 106, 80, 121, 50, 109, 108, 84, 80, 117, 90, 65,
    101, 65, 50, 119, 87, 122, 72, 122, 69, 68, 117, 117, 109, 88, 73, 56, 57,
    106, 72, 56, 97, 95, 81, 73, 86, 56, 59, 32, 102, 114, 61, 48, 106, 81,
    119, 55, 104, 99, 114, 70, 100, 97, 115, 50, 90, 101, 121, 84, 46, 65, 87,
    86, 112, 82, 78, 108, 95, 52, 110, 111, 67, 69, 115, 95, 104, 98, 56, 107,
    97, 90, 97, 104, 115, 45, 106, 65, 46, 66, 104, 114, 81, 113, 97, 46, 51,
    69, 46, 65, 65, 65, 46, 48, 46, 48, 46, 66, 104, 114, 81, 113, 97, 46, 65,
    87, 85, 117, 56, 55, 57, 90, 116, 67, 119
  ]);
